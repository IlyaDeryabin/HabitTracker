...
import ru.d3rvich.habittracker.data.components.DaggerDataComponent
import ru.d3rvich.habittracker.data.components.DataDepsProvider
...
abstract class BaseHabitWorker(appContext: Context, params: WorkerParameters) :
    ...
    override suspend fun doWork(): Result {
        DaggerDataComponent.builder().deps(DataDepsProvider.deps).build().inject(this)
